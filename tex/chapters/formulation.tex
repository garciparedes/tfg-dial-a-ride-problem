...
\begin{document}
  ...
  \label{chap:formulation}
    ...
    \label{sec:formulation_basic_formulation}
      ...
      \paragraph{}
      A lo largo del apartado se han indicado las restricciones que componen la modelización básica del problema \emph{Dial-a-Ride} sobre el marco de \emph{programación lineal mixta}. Una vez hecho esto, tan solo queda remarcar los aspectos más destacados del capítulo en el apartado de conclusiones.
