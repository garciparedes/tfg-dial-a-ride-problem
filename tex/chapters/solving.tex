  ...
  \label{chap:solving}
    ...
    \label{sec:solving_heuristics}
      ...
      \label{sec:solving_greedy}
        ...
        \paragraph{}
        A pesar de ello, tal y como se ha indicado anteriormente, estos algoritmos son capaces de proporcionar resultados relativamente razonables utilizando una cantidad de recursos muy contenida por lo que cuando es tolerable cierto nivel de error respecto de la solución óptima, como es el caso cuando se recurre a estrategias basadas en heurísticas, estos algoritmos proporcionan resultados muy interesantes. Como es natural, el modo en que estos se aplican es muy dependiente de la naturaleza del problema en cuestión. Sin embargo, en el ámbito de los \emph{problemas de optimización combinatoria} es común que la estructura de los mismos tenga unas cierta forma: 

        \paragraph{}
        Por lo general, los algoritmos greedy se construyen como un bucle condicional, que se repite indefinidamente hasta que se cumplen determinadas condiciones como el alcanzamiento de una solución final u otras condiciones relacionadas con el uso de recursos. La acción que se repite en el bucle típicamente es la selección de la mejor alternativa de entre un conjunto de posibles opciones que modifican tanto el valor de la función de coste como el estado actual de la solución.
      ...
      \label{sec:solving_local_search}
        ...
        \begin{algorithm}[ht]
          ...
          \While{$condition$}{
            $current \gets nextNeighbor(current)$\;
          }
