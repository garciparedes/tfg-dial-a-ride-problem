    ...
    \label{sec:implementation}
      ...
      \label{sec:implementation_low_level}
        ...
        \label{sec:implementation_components_data_model}
          ...
          \begin{figure}[ht]
            \centering
            \includegraphics[width=\textwidth,height=0.9\textheight,keepaspectratio]{data-model-overview}
        ...
        \label{sec:implementation_components_optimization}
          ...
          \begin{itemize}
              ...
              \item \texttt{LocalSearchAlgorithm}: [TODO]

                  \begin{itemize}

                      \item \texttt{LocalSearchStrategy}: [TODO]
                  
                      \item \texttt{OneShiftLocalSearchStrategy}: [TODO]
                  
                      \item \texttt{TwoOPTLocalSearchStrategy}: [TODO]
                  
                      \item \texttt{ReallocationLocalSearchStrategy}: [TODO]
                  
                  \end{itemize}

              \item \texttt{SequentialAlgorithm}: [TODO]

              \item \texttt{IterativeAlgorithm}: [TODO]
