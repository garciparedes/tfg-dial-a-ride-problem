  ...
  \label{chap:formulation}
    ...
    \label{sec:formulation_introduction}
      ...
      \label{sec:formulation_combinatorial_problems}
          ...
          \begin{equation}
            \begin{array}{rr@{}ll}
              ...
              \text{sujeto a}	 & \sum\limits_{i = 1}^{N} w_{i}x_{i} \ &\leq W, & \forall i \in \{1,...,N\} \\
                               &                             	x_{i} 	&\in \mathbb{N}, 	                 & \forall i \in \{1,...,N\}
            \end{array}
          \end{equation}
        ...
        \paragraph{}
        [TODO: Describe some combinatorial optimization examples and real applications.]
